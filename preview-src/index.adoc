...
[.card-link]
--
xref:doc-update.adoc[Welcome to the new ThoughtSpot documentation!]
...
Description for
.Description for card 1.Description for card 1.Description for card 1.Description for card 1.Description for card 1.
====
...
== Another tab test with collapsable blocks
...
+
--
This is a standard introductory paragraph.

[%collapsible]
=====
This is the **first** hidden section.
=====

[%collapsible]
=====
This is the **second** hidden section.
=====
--
...
+
--
Regular text content for Tab B.
--
====
