= ThoughtSpot documentation site UI
// Settings:
:experimental:
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/mark-plummer/tsa-docs-ui
:url-preview: https://g-docs-staging.vercel.app/
...
You can see a preview of the ThoughtSpot documentation UI at {url-preview}.
...
It's intentionally minimalistic to give you a good starting point without requiring too much effort to customize.
